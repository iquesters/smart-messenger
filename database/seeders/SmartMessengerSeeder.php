        ...
        'messages' => [
            ...
            'meta_fields' => [
                ...
                'human_route_decision' => [
                    'meta_key' => 'human_route_decision',
                    'type' => 'string',
                    'label' => 'Human Route Decision',
                    'required' => false,
                    'nullable' => true,
                ],
                'human_handover_time' => [
                    'meta_key' => 'human_handover_time',
                    'type' => 'string',
                    'label' => 'Human Handover Time',
                    'required' => false,
                    'nullable' => true,
                ],
                'human_handover_source' => [
                    'meta_key' => 'human_handover_source',
                    'type' => 'string',
                    'label' => 'Human Handover Source',
                    'required' => false,
                    'nullable' => true,
                ],
                'chat_session_id' => [
                ...
                'human_handover_reason' => [
                    'meta_key' => 'human_handover_reason',
                    'type' => 'string',
                    'label' => 'Human Handover Reason',
                    'required' => false,
                    'nullable' => true,
                ],
                'forwarded_from' => [
